...
object VABlocks {
    ...
    var ITEM_PIPE = BLOCKS.register("item_pipe") {
        ItemPipe(BlockBehaviour.Properties.of(Material.METAL).strength(2.0f))
    }

    var FLUID_PIPE = BLOCKS.register("fluid_pipe") {
        FluidPipe(BlockBehaviour.Properties.of(Material.METAL).strength(2.0f))
    }
